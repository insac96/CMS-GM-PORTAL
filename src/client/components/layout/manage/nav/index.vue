...
const navItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Giá VIP và NDT', to: '/manage/@eni/config/vipyuan' },
    ]
  },
  {
    label: 'Bài viết',
    ...
    children: [
      ...
      { label: 'Nạp game China', to: '/manage/@eni/config/article/china/payment' },
      { label: 'Căn cước game China', to: '/manage/@eni/config/article/china/passport' },
    ]
  },
  {
    label: 'Địa chỉ IP',
