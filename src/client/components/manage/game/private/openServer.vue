...
const getList = async () => {
  try {
    ...
    const data = await useAPI('game/private/manage/server/open/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('game/private/manage/server/open/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('game/private/manage/server/open/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('game/private/manage/server/open/del', { 
      game: props.game,
      _id: _id
    })
