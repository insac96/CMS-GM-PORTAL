<template>
  <UiContent title="Game Tool Income" sub="Lịch sử thu nhập từ Game Tool">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('collab/manage/code/income/game/tool', JSON.parse(JSON.stringify(page.value)))
