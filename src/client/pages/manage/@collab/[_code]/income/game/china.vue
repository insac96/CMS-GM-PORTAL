<template>
  <UiContent title="Game China Income" sub="Lịch sử thu nhập từ Game China">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('collab/manage/code/income/game/china', JSON.parse(JSON.stringify(page.value)))
