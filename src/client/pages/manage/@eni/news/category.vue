<template>
  <UiContent title="Category" sub="Quản lý các danh mục tin tức">
    <UiFlex class="mb-4">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('news/manage/category/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('news/manage/category/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('news/manage/category/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('news/manage/category/del', { _id })
