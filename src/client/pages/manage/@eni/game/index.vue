...
<script setup>
  ...
  const actions = (row) => [
    [{
      ...
      click: async () => {
        try {
          const content = await useAPI('game/manage/project/getContent', { _id: row._id })
  ...
  const getList = async () => {
    try {
      ...
      const data = await useAPI('game/manage/project/list', JSON.parse(JSON.stringify(page.value)))
  ...
  const addAction = async () => {
    try {
      ...
      await useAPI('game/manage/project/add', JSON.parse(JSON.stringify(stateAdd.value)))
  ...
  const editInfoAction = async () => {
    try {
      ...
      await useAPI('game/manage/project/edit/info', JSON.parse(JSON.stringify(stateEditInfo.value)))
  ...
  const editImageAction = async () => {
    try {
      loading.value.edit = true
      await useAPI('game/manage/project/edit/image', JSON.parse(JSON.stringify(stateEditImage.value)))
  ...
  const editAPIAction = async () => {
    try {
      loading.value.edit = true
      await useAPI('game/manage/project/edit/api', JSON.parse(JSON.stringify(stateEditAPI.value)))
  ...
  const editPriceAction = async () => {
    try {
      loading.value.edit = true
      await useAPI('game/manage/project/edit/price', JSON.parse(JSON.stringify(stateEditPrice.value)))
  ...
  const editContentAction = async () => {
    try {
      loading.value.edit = true
      await useAPI('game/manage/project/edit/content', JSON.parse(JSON.stringify(stateEditContent.value)))
  ...
  const delAction = async (_id) => {
    try {
      ...
      await useAPI('game/manage/project/del', { _id })
