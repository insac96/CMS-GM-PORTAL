<template>
  <UiContent title="Ecoin Seller" sub="Quản lý các thương gia bán Ecoin">
    <UiFlex class="mb-4">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('ecoin/manage/p2p/buy/list', JSON.parse(JSON.stringify(page.value)))
