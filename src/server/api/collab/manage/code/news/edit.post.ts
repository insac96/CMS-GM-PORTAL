import type { IAuth, IDBCollab, IDBNews, IDBNewsCategory } from "~~/types"
...
export default defineEventHandler(async (event) => {
  try {
    ...
    if(newsCheck.collab.toString() != collab._id.toString()) throw 'Tin tức không thuộc cộng tác viên này'
